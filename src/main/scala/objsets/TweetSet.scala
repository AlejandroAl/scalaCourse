...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = {
    ...
    if (left.isEmpty && right.isEmpty) elem
      ...
      val mostTweetleft = left.mostRetweeted
      if (mostTweetleft.retweets > elem.retweets) mostTweetleft else elem
    }
    else if (left.isEmpty && !right.isEmpty) {
      val mostTweetRigh = right.mostRetweeted
      if (mostTweetRigh.retweets > elem.retweets) mostTweetRigh else elem
    }
    else {
      val mostTweetleft = left.mostRetweeted
      val mostTweetRigh = right.mostRetweeted

      if(mostTweetleft.retweets > mostTweetRigh.retweets) {
        if(mostTweetleft.retweets > elem.retweets) mostTweetleft else elem
      } else {
        if(mostTweetRigh.retweets > elem.retweets) mostTweetRigh else elem
      }
